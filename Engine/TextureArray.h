...
TextureArray::TextureArray(s8 const* pTextureSource, u32 tileSize, u32 numTiles)
{
  ...
  glTexStorage3D(GL_TEXTURE_2D_ARRAY, 1, GL_RGBA32F, tileSize, tileSize, numTiles);
  ...
  glTexSubImage3D(GL_TEXTURE_2D_ARRAY, 0, 0, 0, 0, tileSize, tileSize, numTiles, GL_RGBA, GL_FLOAT, textureBuffer.data());
